@include("header")
    ...
    <section class="banner--static">
      <div class="container-fluid px-0">
        <div class="row">
          <div class="col-12"><img class="w-100 img-fluid" src="{{ URL::asset('images/birthday-banner-2.png')}}">
            <div class="banner--cont"><h1><span class="d-block">HAPPY</span> NATIONALDAY</h1></div>
        </div>
      </div>
    </section>
        ...
        <div class="row">
            ...
            <div class="celebrity_slide-images">
              <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                  @if (!empty($list_data->image) && File::exists("app/public/".$list_data->image))
                        ...
                        <div class="carousel-item active" data-bs-interval="3000">
                            <img src="{{env('APP_URL')}}/app/public/{{$list_data->image}}" class="d-block w-100" alt="...">
                        </div>
                    ...
                    @else 
                        ...
                        <img src="{{ URL::asset('assets/img/logo-dn-modified.png')}}" alt="Image" style="height:auto; width: 400px; margin: 95px 155px;" />
                        </div>
                ...
                <div class="celeb--slide--cont">
                  <h2 class="name-celeb text-white">{{$list_data->name}}- (National Day)</h2>
                  <ul class="rating_list list-unstyled mb-0 d-flex">
                    <p class="text-white mb-0">Rating:</p>
                    <li><a href="#"><img src="{{env('APP_URL')}}/images/star-filled.png"></a></li>
                    <li><a href="#"><img src="{{env('APP_URL')}}/images/star-filled.png"></a></li>
                    <li><a href="#"><img src="{{env('APP_URL')}}/images/star-filled.png"></a></li>
                    <li><a href="#"><img src="{{env('APP_URL')}}/images/star-filled.png"></a></li>
                    <li><a href="#"><img src="{{env('APP_URL')}}/images/star-grey.png"></a></li>
                  </ul>
                </div>
              </div>              
            </div>
            <div class="bio--graphy">
              <div class="heading--title"><span>HISTORY</span></div>
              <p>{!!$list_data->body!!}</p>
              @if (!empty($list_data->image) && File::exists("app/public/".$list_data->image))
                    <img class="celeb-small-img mb-4 w-100- img-fluid- " src="{{env('APP_URL')}}/app/public/{{$list_data->image}}">
                @else 
                    <div class="carousel-item_" data-bs-interval="3000">
                    <img src="{{ URL::asset('assets/img/logo-dn-modified.png')}}" alt="Image" style="height:auto; width: 400px; margin: 95px 155px;" />
                    </div>
          ...
          <div class="col-lg-4">
            <div class="quick-facts">
              ...
              <li class="d-flex">
                  <div class="fact-ques">Name:</div>
                  <div class="fact-ans">{{$list_data->name}}</div>
                </li>
                <li class="d-flex">
                  <div class="fact-ques">When Is It:</div>
                  <div class="fact-ans">{{$list_data->DOB}}</div>
                </li>
                <li class="d-flex">
                  <div class="fact-ques">Tagged As:</div>
                  <div class="fact-ans">{{$list_data->reasonforfame}}</div>
                </li>
                <li class="d-flex">
                  <div class="fact-ques">Hash Tags</div>
                  <div class="fact-ans">{{$list_data->hashtag}}</div>
                </li>
              </ul>
  ...
  <a class="moreless-button" href="#">Read more</a>
    ...
    <section class="addisional-info">
      <div class="container">
        <div class="row">
          <div class="add--info">
              <div class="heading--title"><span>ABOUT</span></div>
              <p>{!!$list_data->body!!}</p>
      ...
      <div id="slider--similar--person">
        <div class="owl-carousel owl-theme">
           @foreach($simillarcelebrity_data as $simillercel)
            ...
            <a style="text-decoration: none;" href="{{str_replace(' ','-',strtolower($simillercel->name))}}" >
                <img src="{{env('APP_URL')}}/app/public/{{$simillercel->image}}">
            </a>
                @else
                <a style="text-decoration: none;" href="{{str_replace(' ','-',strtolower($simillercel->name))}}" >
                <img src="{{ URL::asset('assets/img/logo-dn-modified.png')}}" alt="Image" style="height: 167px;" />
                </a>
                @endif
